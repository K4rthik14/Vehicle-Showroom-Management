...
<div class="row g-3">
    <div class="col-lg-4">
        <div class="card-vsms">
            <div class="card-header"><i class="bi-shield-lock me-2 text-primary"></i>
...
endwhile; ?>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <?php if ($editUser): ?><a href="users.php" class="btn btn-outline-vsms">Cancel</a>
                        <?php
endif; ?>
                    </div>
                </form>
    ...
    <div class="col-lg-8">
        <div class="card-vsms">
            <div class="card-header"><i class="bi-shield-lock me-2 text-primary"></i>System Users (
                <?= $users->num_rows?>)
            </div>
                ...
                <table class="table table-vsms mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge <?= $user['role'] === 'admin' ? 'bg-danger' : 'bg-primary'?>">
                                    <?= ucfirst($user['role'])?>
                                </span></td>
                            <td>
                            ...
                            <td>
                                <a href="users.php?edit=<?= $user['user_id']?>"
                                    class="btn btn-sm btn-outline-secondary me-1"><i class="bi-pencil"></i></a>
                                <?php if ($user['user_id'] != $_SESSION['user_id']): ?>
                                <a href="users.php?delete=<?= $user['user_id']?>" class="btn btn-sm btn-outline-danger"
