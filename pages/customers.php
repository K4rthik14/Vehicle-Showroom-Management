...
<div class="row g-3">
    <div class="col-lg-4">
        <div class="card-vsms">
            <div class="card-header"><i class="bi-person-plus me-2 text-primary"></i>
                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="address" class="form-control"
                            rows="2"><?= htmlspecialchars($editData['Address'] ?? '')?></textarea>
                    </div>
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary-vsms">
                            <?= $editData ? 'Update' : 'Add Customer'?>
                        </button>
                        <?php if ($editData): ?><a href="customers.php" class="btn btn-outline-vsms">Cancel</a>
                        <?php
endif; ?>
                    </div>
                </form>
    ...
    <div class="col-lg-8">
        <div class="card-vsms">
            <div class="card-header"><i class="bi-people me-2 text-primary"></i>All Customers (
                <?= $customers->num_rows?>)
            </div>
                ...
                <table class="table table-vsms mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="customers.php?edit=<?= $c['Customer_ID']?>"
    ...
    endwhile; ?>
                ...
                <div class="empty-state"><i class="bi-people"></i>
