...
<div class="row g-3">
    <div class="col-lg-4">
        <div class="card-vsms">
            <div class="card-header"><i class="bi-truck me-2 text-primary"></i>
                ...
                <form method="POST">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="s_name" class="form-control" required
                            value="<?= htmlspecialchars($editData['S_Name'] ?? '')?>">
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Phone Number</label>
                        <input type="text" name="phone_no" class="form-control" maxlength="15"
                            value="<?= htmlspecialchars($editData['Phone_No'] ?? '')?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <?php if ($editData): ?><a href="suppliers.php" class="btn btn-outline-vsms">Cancel</a>
                        <?php
endif; ?>
                    </div>
                </form>
    ...
    <div class="col-lg-8">
        <div class="card-vsms">
            <div class="card-header"><i class="bi-truck me-2 text-primary"></i>All Suppliers (
                <?= $suppliers->num_rows?>)
            </div>
                ...
                <table class="table table-vsms mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="suppliers.php?edit=<?= $s['Supplier_ID']?>"
                                    class="btn btn-sm btn-outline-secondary me-1"><i class="bi-pencil"></i></a>
                                <?php if (isAdmin()): ?>
                                <a href="suppliers.php?delete=<?= $s['Supplier_ID']?>"
                                    class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure?')"><i
                                        class="bi-trash"></i></a>
                                <?php
        endif; ?>
                            </td>
    ...
    endwhile; ?>
                ...
                <div class="empty-state"><i class="bi-truck"></i>
